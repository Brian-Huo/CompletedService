...
type CreateOrderRequest struct {
	...
	Service_list      []SelectServiceStructure `json:"service_list"`
...
type AddOrderServiceRequest struct {
	Order_id int64                    `json:"order_id"`
	Items    []SelectServiceStructure `json:"items"`
}
...
type DetailOrderResponse struct {
	...
	Basic_items           SelectServiceStructure   `json:"basic_items"`
	Additional_items      []SelectServiceStructure `json:"additional_items"`
...
type SelectServiceStructure struct {
